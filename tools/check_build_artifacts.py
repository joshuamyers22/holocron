...
def inspect_artifacts(directory: Path) -> tuple[Path, Path]:
    ...
    expected_sdist_files = {
        ...
        f"{sdist_root}/schemas/pooled-anova-result.schema.json",
        f"{sdist_root}/schemas/pooled-calibration-result.schema.json",
        f"{sdist_root}/schemas/pooled-model-result.schema.json",
        f"{sdist_root}/schemas/pooled-validation-result.schema.json",
    ...
    expected_schema_files = {
        ...
        "holocron/schemas/pooled-anova-result.schema.json",
        "holocron/schemas/pooled-calibration-result.schema.json",
        "holocron/schemas/pooled-model-result.schema.json",
        "holocron/schemas/pooled-validation-result.schema.json",
