...
| experimental | 41 | Implemented narrowly with parity evidence; not production-ready. |
...
| deferred | 235 | Catalogued for a later phase; no current implementation claim. |
...
| `npsurv` | export | `holocron.models.fit_npsurv` | experimental | Phase 4-5 | 3 | `nonparametric-survival-risk-set-v2`, `nonparametric-survival-v1` | Right-censored and counting-process Kaplan-Meier curves support strata and positive frequency weights with weighted risk/event/censor counts and log-scale Greenwood intervals. Alternate estimators, robust variance, and formula-level fitting remain deferred. |
...
| `psm` | export | `holocron.models.fit_psm` | experimental | Phase 4-5 | 3 | `parametric-survival-risk-set-v2`, `parametric-survival-v1` | Right-censored Weibull and exponential AFT fits support positive weights, offsets, observed covariance, survival/hazard prediction, and response/normalized/martingale/deviance residuals; Weibull additionally supports scale strata. Other distributions, left/interval censoring, and formula-level fitting remain deferred. |
