...
| `formula-design` | The Phase 2 allowlisted additive numeric formula AST and identity/polynomial/linear-spline/restricted-cubic-spline design compiler are complete for the experimental envelope. Parsing never evaluates source; categorical terms and interactions remain next. | `governance/PHASE_2_FORMULA_DESIGN.md`; `src/holocron/formula/`; `src/holocron/design/formula.py`; `reference/cases/design-*.json` | 2026-09-17 |
