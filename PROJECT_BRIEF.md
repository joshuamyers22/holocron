...
- Status and scope: Phases 0–2 complete and Phase 3 active for private experimental development as of 2026-09-18; Phase 3 core `ols`, Gaussian/binomial `Glm`, and binary `lrm` estimators, result operations, diagonal OLS/lrm penalties, and robust/bootstrap covariance are complete within their experimental envelope, simulation reports and the numerical edge-case corpus are next, and external distribution and non-experimental statistical claims remain blocked
