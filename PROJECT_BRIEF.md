...
- Status and scope: Phases 0–7 complete and Phase 8 underway for private experimental development as of 2026-09-19; its first two deliverables supply bounded mapped replacements for `Gls`, `Rq`, `bj`, `pphsm`, `processMI`, and `prmiInfo`, while complete method-level namespace disposition is next and capability promotion, consequential use, and external distribution remain blocked by their separate reviews
