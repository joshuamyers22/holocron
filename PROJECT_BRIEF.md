...
- Status and scope: Phases 0–7 complete and Phase 8 underway for private experimental development as of 2026-09-19; its first deliverable supplies bounded mapped replacements for `Gls`, `Rq`, `bj`, and `pphsm` plus reviewed dispositions for the remaining Phase 8 exports, while multiple imputation is next and capability promotion, consequential use, and external distribution remain blocked by their separate reviews
