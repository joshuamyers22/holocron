...
check: lock-check lint typecheck test docs-check svg-check frozen-environments reference-metadata phase-1-e2e phase-2-evidence phase-3-evidence phase-4-evidence phase-5-evidence
audit:
