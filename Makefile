.PHONY: setup lock-check format lint typecheck test docs docs-generate docs-check svg-check frozen-environments frozen-environments-live reference-metadata migration-catalog migration-check tolerance-pilot phase-1-e2e phase-1-exit-gate phase-2-evidence phase-2-exit-gate phase-3-evidence phase-3-evidence-clean phase-4-evidence phase-4-evidence-clean phase-5-evidence phase-5-evidence-clean phase-8-profiles phase-8-profiles-clean phase-9-rc-check phase-9-rc-exit-gate phase-9-build-matrix-check phase-9-build-matrix-evidence phase-9-readiness-check phase-9-readiness-exit-gate check audit build clean-build oracle-build oracle-health oracle-check reference-source-check
setup:
	uv lock --check
...
check: lock-check lint typecheck test docs-check svg-check frozen-environments reference-metadata migration-check phase-1-e2e phase-2-evidence phase-3-evidence phase-4-evidence phase-5-evidence phase-8-profiles phase-9-rc-check phase-9-build-matrix-check phase-9-readiness-check
audit:
